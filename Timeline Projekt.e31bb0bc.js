...
function resizeSeasonDiv() {
  ...
  var returnBox = document.querySelector("#".concat(expandedDiv.id, " .returnButton"));
...
function closeActiveDiv(expandedDiv, returnBox, menuFlag, menuItem) {
  ...
  var points = document.querySelectorAll("#".concat(expandedDiv.id, " .svgGroup"));
  points.forEach(function (bullet) {
    bullet.style = null;
  });
...
//# sourceMappingURL=/Timeline%20Projekt.e31bb0bc.js.map